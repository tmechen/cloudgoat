#IAM Role
resource "aws_iam_role" "k4-banking-WAF-Role" {
  name = "k4-banking-WAF-Role-${var.cgid}"
...
resource "aws_iam_role_policy_attachment" "k4-banking-WAF-Role-policy-attachment-s3" {
  role = "${aws_iam_role.k4-banking-WAF-Role.name}"
